...
const RoomSelected = () => {
 ...
 <div className="mx-10 mt-10">
    ...
    <div className='flex flex-col lg:flex-row w-full gap-5 justify-between py-8 lg:py-14'>
        ...
        <div className="flex items-center justify-end gap-12">
          <div>
            <p className="text-3xl text-[#001F54] font-poppins-bold">{roomDetails.price +" 5000"}</p>
          </div>
