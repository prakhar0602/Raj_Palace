    ...
    return (
      <div className=" min-h-screen font-sans pt-24 lg:pt-44">
        ...
        <main className="flex flex-col md:flex-row justify-around items-start md:items-center py-16 px-8 space-y-10 md:space-y-0">
          <div className="max-w-lg text-[#1A1A1A] space-y-6 bg-[#d5d5d5] p-6 rounded-lg shadow-md font-poppins tracking-wider">
          ...
          <div className="w-full md:w-1/2 lg:h-96 h-64 rounded-lg overflow-hidden shadow-md">
            <iframe 
