...
const Gallery = () => {
  ...
  const images = [g1,g2,a1,a2,a3,a4,a5,a6,a7,a8,a9,a10];

  return (
    <div className="flex flex-col justify-center items-center">
      {/* Section Header */}
      <h2 className="md:text-5xl text-2xl font-garamond font-bold text-center text-[#001F54] md:mb-14 mb-4 tracking-wider">
      GRANDEUR ESCAPES
      </h2>

      {/* Image Grid */}
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 px-4 max-w-7xl mx-auto justify-center">
  {images.map((src, index) => (
    <div
      key={index}
      className="overflow-hidden rounded-xl shadow-[0_8px_24px_rgba(214,174,98,0.4)] border-[1px] border-[#001F54] hover:scale-105 transition-transform duration-500 ease-in-out flex justify-center items-center"
    >
